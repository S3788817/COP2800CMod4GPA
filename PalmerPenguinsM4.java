...
public static void main(String[] args) {
    ...
    while ((line = CSVReader.readFile(
                FILE_NAME, currRow++)) != null) {

        // Check species in the line,
        // increment appropriate accumulator
        if (line.contains(SP_CHINSTRAP)) {
            specChinStrapCount++;

        // TODO 2 complete the branches
        // to increment the accumulators
